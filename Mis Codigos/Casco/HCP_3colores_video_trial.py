...
deviceID = 'ca1f370b-3b18-4919-ac93-f606f0c00419'
url = url +deviceID
headers = urllib3.util.make_headers()
headers['Authorization'] = 'Bearer ' + '299425c6b5b5737fe8bc54aa6797a' 
...
def hcp(p_red, p_green, p_blue):
    ...
    body='{"messageType":"544f59660d6ae60e00e8","mode":"sync","messages":[{"timestamp":'
    body=body+timestamp
